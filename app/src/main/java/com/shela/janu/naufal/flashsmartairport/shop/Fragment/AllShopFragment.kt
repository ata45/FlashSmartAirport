...
class AllShopFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        rcy_shop_food.layoutManager = LinearLayoutManager(activity,  LinearLayoutManager.HORIZONTAL, false)
        rcy_shop_food.adapter = foodAdapter

        rcy_shop_souvenir.layoutManager = LinearLayoutManager(activity,  LinearLayoutManager.HORIZONTAL, false)
