package com.shela.janu.naufal.flashsmartairport.services
...
class NotificationService : IntentService("NotificationService") {
    ...
    companion object {
        ...
        const val CHANNEL_ID = "com.shela.janu.naufal.flashsmartairport.CHANNEL_ID"
    ...
    override fun onHandleIntent(intent: Intent?) {
        ...
        if (intent != null && intent.extras != null) timestamp = intent.extras!!.getLong("timestamp")
